...
public class InscriptionAsync extends AsyncTask<String, Void, Utilisateur> {
    private Activity activity;
    private Intent intent;

    public InscriptionAsync(Activity act) {
        this.activity = act;
    }
    ...
    protected Utilisateur doInBackground(String... strings) {
        ...
        try {
            ...
            byte[] tab = ("pseudo=" + strings[0] + "&motDePasse=" + strings[1] + "&sexe=" + strings[2] + "&ville=" + strings[3]).getBytes();
